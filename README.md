...
## Environments
- Preview: https://main--geraldtrix--srobins.hlx.page/
- Live: https://main--geraldtrix--srobins.hlx.live/
...
1. Open the `geraldtrix` directory in your favorite IDE and start coding :)
